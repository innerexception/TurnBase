export default {
    ...
    Units: {
        DefaultPositions: [
            ...
            {type: 'artillery', number: 1, owner: 'FR', region: 'Switzerland'},
            {type: 'tank', number: 1, owner: 'US', region: 'CentralFrance'},
            //{type: 'infantry', number: 1, owner: 'US', region: 'Normandy'},
            //{type: 'infantry', number: 1, owner: 'FR', region: 'Normandy'},
            //{type: 'fighter', number: 1, owner: 'US', region: 'Normandy'},
            //{type: 'aaa', number: 1, owner: 'US', region: 'Normandy'},
            {type: 'tank', number: 1, owner: 'FR', region: 'Switzerland'},
            {type: 'aaa', number: 1, owner: 'FR', region: 'Switzerland'},
