...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MapReducer = __webpack_require__(182);
	...
	var store = (0, _redux.createStore)(_MapReducer2.default, (0, _redux.applyMiddleware)(_reduxThunk2.default // lets us dispatch() functions
	));
...
/***/ function(module, exports) {
	...
	var mapReducer = function mapReducer(state, action) {
	    switch (action.type) {
	        case 'REGION_CLICKED':
	            return state.regions.map(function (region) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MapStateContainer = __webpack_require__(184);

	var _MapStateContainer2 = _interopRequireDefault(_MapStateContainer);
	...
	var App = function (_React$Component) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            dispatch((0, _MapActions.fetchMap)('./res/svg/baseMap.svg'));
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { className: 'turnbase-app' },
	                _react2.default.createElement(_MapStateContainer2.default, null)
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MapStateContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_Map2.default);

	exports.default = MapStateContainer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.fetchMap = exports.regionClicked = undefined;

	var _fs = __webpack_require__(186);

	var _fs2 = _interopRequireDefault(_fs);

	var _xmlParser = __webpack_require__(187);
	...
	var fetchMap = exports.fetchMap = function fetchMap(svgPath) {
	    return {
	        type: 'MAP_LOAD',
	...
	var getRegionsFromSVG = function getRegionsFromSVG(svgPath) {
	    var xml = _fs2.default.readFileSync(svgPath, 'utf8');
	    var svgObj = (0, _xmlParser2.default)(xml);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var debug = __webpack_require__(188)('xml-parser');
	...
	var _getRegionPaths = function _getRegionPaths(regions, onRegionClick) {
	    return regions.map(function (region) {
	        return _react2.default.createElement('path', { onClick: function onClick() {
	                return onRegionClick(region.id);
	            }, d: region.d, id: region.id, title: region.title, className: 'turnbase-region' });
	    });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".turnbase-region{\r\n    fill: steelblue;\r\n    fill-opacity: 1;\r\n    stroke:darkgrey;\r\n    stroke-opacity: 1;\r\n    stroke-width:0.5;\r\n}", ""]);
